...
namespace Config::Supplementary {
     ...
     */
        ...
        SConfigOptionDescription{
            ...
            .description =
                "if enabled, floating windows will ignore tiled windows in their blur. Only available if blur_new_optimizations is true. Will reduce overhead on floating "
                "blur significantly.",
            .type = CONFIG_OPTION_BOOL,
            .data = SConfigOptionDescription::SBoolData{false},
        },
     ...
     */
        ...
        SConfigOptionDescription{
            ...
            .description =
                "Force no cursor acceleration. This bypasses most of your pointer settings to get as raw of a signal as possible. Enabling this is not recommended due to "
        ...
        SConfigOptionDescription{
            ...
            .description =
                "If the scroll button lock is enabled, the button does not need to be held down. Pressing and releasing the button toggles the button lock, which logically "
        ...
        SConfigOptionDescription{
            ...
            .description =
                "If enabled (1 or 2), focus will change to the window under the cursor when changing from tiled-to-floating and vice versa. If 2, focus will also follow "
        ...
        SConfigOptionDescription{
            ...
            .description =
                "Handles axis events around (gaps/border for tiled, dragarea/border for floated) a focused window. 0 ignores axis events 1 sends out-of-bound coordinates 2 "
        ...
        SConfigOptionDescription{
            ...
            .description =
                "Emulates discrete scrolling from high resolution scrolling events. 0 disables it, 1 enables handling of non-standard events only, and 2 force enables all "
        ...
        SConfigOptionDescription{
            ...
            .description = "Sending LMB and RMB simultaneously will be interpreted as a middle click. This disables any touchpad area that would normally send a middle click "
                           "based on location.",
            .type        = CONFIG_OPTION_BOOL,
            .data        = SConfigOptionDescription::SBoolData{false},
        },
        ...
        SConfigOptionDescription{
            ...
            .description = "Button presses with 1, 2, or 3 fingers will be mapped to LMB, RMB, and MMB respectively. This disables interpretation of clicks based on location on "
                           "the touchpad.",
            .type        = CONFIG_OPTION_BOOL,
            .data        = SConfigOptionDescription::SBoolData{false},
        },
     ...
     */
        ...
        SConfigOptionDescription{
            ...
            .description = "The class regex to be used for windows that should be swallowed (usually, a terminal). To know more about the list of regex which can be used use this "
                           "cheatsheet.",
            .type        = CONFIG_OPTION_STRING_SHORT,
            .data        = SConfigOptionDescription::SStringData{""}, //##TODO UNSET?
        },
        SConfigOptionDescription{
            ...
            .description =
                "The title regex to be used for windows that should not be swallowed by the windows specified in swallow_regex (e.g. wev). The regex is matched against the "
     ...
     */
        ...
        SConfigOptionDescription{
            ...
            .description =
                "If enabled, workspaces don’t forget their previous workspace, so cycles can be created by switching to the first workspace in a sequence, then endlessly "
     ...
     */
        ...
        SConfigOptionDescription{
            ...
            .description =
                "Default transfer function for displaying SDR apps. default - Use default value (Gamma 2.2), gamma22 - Treat unspecified as Gamma 2.2, gamma22force - Treat "
     ...
     */
        ...
        SConfigOptionDescription{
            ...
            .description =
                "disables scheduling new frames on cursor movement for fullscreen apps with VRR enabled to avoid framerate spikes (may require no_hardware_cursors = true) "
        ...
        SConfigOptionDescription{
            ...
            .description =
                "sync xcursor theme with gsettings, it applies cursor-theme and cursor-size on theme load to gsettings making most CSD gtk based clients use same xcursor "
                "theme and size.",
            .type = CONFIG_OPTION_BOOL,
            .data = SConfigOptionDescription::SBoolData{true},
        },
     ...
     */
        ...
        SConfigOptionDescription{
            ...
            .description = "if enabled, resizing direction will be determined by the mouse's position on the window (nearest to which corner). Else, it is based on the window's "
                           "tiling position.",
            .type        = CONFIG_OPTION_BOOL,
            .data        = SConfigOptionDescription::SBoolData{true},
        },
